...
set_of_data = gi.datasets.get_datasets()
...
for filename in data:
    ...
    download_dataset("UKER" + str(l), dataset_id='', file_path='/Desktop/Ergebnisse_workflow/UKER' + str(l) + "main", user_default_filename=False)
    download_dataset("UKER" + str(l), dataset_id='', file_path='/Desktop/Ergebnisse_workflow/UKER' + str(l) + "annotation", user_default_filename=False)
    download_dataset("UKER" + str(l), dataset_id='', file_path='/Desktop/Ergebnisse_workflow/UKER' + str(l) + "report", user_default_filename=False)
