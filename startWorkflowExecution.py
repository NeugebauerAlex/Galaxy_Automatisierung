...
for filename in data:
  ...
  #  sd = gi.histories.show_matching_datasets(history_id = get_id["id"], name_filter=None)
    ...
    gi.histories.download_dataset(history_id= li, dataset_id='', file_path='/home/neugebax/UKER' + str(l) + 'main', user_default_filename=False)
    gi.histories.download_dataset(history_id= li, dataset_id='', file_path='/home/neugebax/UKER' + str(l) + 'annotation', user_default_filename=False)
    gi.histories.download_dataset(history_id= li, dataset_id='', file_path='/home/neugebax/UKER' + str(l) + 'report', user_default_filename=False)
