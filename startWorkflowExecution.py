...
#hh = gi.histories.show_history(history_id = hl, contents=True, deleted=None, visible=True, details=True, types=None)
print(hl)
...
for filename in data:
   ...
   # data_info = hh.show_history(history_id='UKER' + str(l), contents=True, deleted=None, visible=True, details=True, types=None)
   # print(data_info)
