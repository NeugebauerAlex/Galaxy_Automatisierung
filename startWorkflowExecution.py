...
for filename in data:
    os.system(
        "python3 run_workflow_panel_main.py --forward_reads UKER" + str(
            ...
            l) + "_R1_merged.fastq.gz --dbsnp_records abafdf086c375ee5 --api_key 64b1a4440d46af31d546df70cc5db50d --galaxy_url http://srv-ap-omics1.srv.uk-erlangen.de/ --workflow_id_override=319886f37b7797fe --new_history_name UKER" + str(
            l))
 ...
 #   os.system(
  ...
  #          l) + "--gemini_db_of_variants --uniprot_annotated_cancer_genes 07acaf50ebe1f533 --cgi_listed_genes 8aab8fda5bfd5997  --civic_genes d513c0e53ab96eac --api_key 64b1a4440d46af31d546df70cc5db50d --galaxy_url http://srv-ap-omics1.srv.uk-erlangen.de/ --workflow_id_override=8c959c9304a2bc4b")
    ...
    gi.histories.download_dataset(history_id=li_element, dataset_id=li_element, file_path='/home/neugebax/UKER_main', use_default_filename=True)
